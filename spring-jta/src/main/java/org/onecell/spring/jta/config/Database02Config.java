...
@Configuration
public class Database02Config {
    @Bean(name = "databaseProp2")
    @ConfigurationProperties(prefix = "database2")
    public DatabaseProp databaseProp2()
    {
    ...
    {
        AtomikosDataSourceBean atomikosDataSourceBean = DataSourceBeanFactory.atomikosDataSourceBean("2", databaseProp2());
    ...
    public SessionFactory sessionFactory2() throws IOException {
        ...
        LocalSessionFactoryBean xaLocalSessionFactoryBean = sessionFactoryBeanFactory.createXaLocalSessionFactoryBean(dataSource2(), packagesScanPath, properties);
