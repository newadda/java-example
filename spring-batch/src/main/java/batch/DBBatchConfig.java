...
public class DBBatchConfig  implements  IBatchConfig{
    ...
    public DBBatchConfig(DataSource dataSource) throws Exception {
        ...
        this.jobOperator = craeteJobOperator(this.jobExplorer, this.jobLauncher, this.jobRepository, this.jobRegistry );
    }
    ...
    protected JobOperator craeteJobOperator(JobExplorer jobExplorer, JobLauncher jobLauncher, JobRepository jobRepository, JobRegistry jobRegistry) {
