...
import static org.onecellboy.util.DatabaseType.SQLITE;

public class DBShemaManager {
    ...
    public DBShemaManager(DataSource dataSource) throws MetaDataAccessException {
        ...
        DatabaseType databaseType = DatabaseType.fromMetaData(dataSource);
            ...
            this.createSchemaScript = "/org/xitech/collector/lib/db/schema-sqlite.sql";
