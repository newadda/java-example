package org.onecellboy.lib.querydsl;
...
public class SpringQueryDSLUtil {
    ...
    * */
    ...
    public static  <T>  PageImpl<T> createPage(QueryResults<T> queryResults, Pageable pageable )
    {
        return new PageImpl<T>(queryResults.getResults(), pageable, queryResults.getTotal());
    }
